...
var copilotOpt copilot.CopilotOption
var verbose string

const welcome = `Welcome to Ops-copilot. Please type "exit" or "q" to quit.`
const quit = "Goodbye!"
const prompt = "Ops-copilot> "
...
func CreateCopilot(logger *log.Logger, opt copilot.CopilotOption) {
	fmt.Println(welcome)
...
func fillParameters(opt *copilot.CopilotOption) {
	if opt.Endpoint == "" {
